...
#if 0
  fprintf (stdout, "Dopo RestoreInUniqueRecurBdd\n");
  My_PrintConstants (ddMgr);
#endif
...
{
  /* StQ 01.08.2005
     Impossible to Deal with terminals as with other nodes
     (0 versus 1 value) */
  if (!Cudd_IsConstant (f)) {
...
/**Function********************************************************************
  ...
  SeeAlso      [DddmpIsVisitedCnf (), DddmpClearVisitedCnf ()]
...
/**Function********************************************************************
  ...
  SeeAlso      [DddmpIsVisitedCnf (), DddmpSetVisitedCnf ()]
